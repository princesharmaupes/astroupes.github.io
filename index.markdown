  ...
  <div style="display:flex; flex-wrap:wrap; gap:18px; justify-content:space-between; align-items:flex-start;">
    <div style="flex:1 1 420px; min-width:280px;">
      ...
      <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:14px;">
        ...
        <a href="/programs" style="background:rgba(255,255,255,0.14); color:#fff; text-decoration:none; padding:10px 16px; border-radius:10px; border:1px solid rgba(255,255,255,0.28); font-weight:700;">Explore Programs</a>
